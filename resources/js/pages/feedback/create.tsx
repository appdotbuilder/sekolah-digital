            ...
            <div className="bg-gradient-to-b from-gray-900 to-black py-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                        Sampaikan kritik, saran, atau masukan Anda untuk kemajuan SMA Negeri 1
                    </p>
                </div>
            </div>
                ...
                <div className="bg-gray-900 rounded-xl p-8 border border-yellow-500/20">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-300">
                            Saran Anda sangat berharga bagi kami. Mohon sampaikan dengan bahasa yang sopan dan konstruktif.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="bg-blue-900/50 border border-blue-400/50 rounded-lg p-4">
                            <div className="flex items-start">
                                ...
                                <div>
                                    <h4 className="text-blue-400 font-semibold mb-2">Tips Memberikan Saran yang Efektif:</h4>
                                    <ul className="text-blue-100 text-sm space-y-1">
                                        <li>• Gunakan bahasa yang sopan dan konstruktif</li>
                                        <li>• Berikan contoh konkret jika memungkinkan</li>
                                        <li>• Sertakan usulan solusi bila ada</li>
                                        <li>• Fokus pada hal-hal yang dapat diperbaiki</li>
                                        <li>• Hindari menyebutkan nama pribadi secara negatif</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
